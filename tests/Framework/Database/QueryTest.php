...
class QueryTest extends DatabaseTestCase
{
    ...
    public function testJoinQuery()
    {
        ...
        ;
        $queryTest = "SELECT name FROM posts AS p LEFT JOIN categories AS c ON c.id = p.category_id";
        $queryTest = "$queryTest INNER JOIN categories AS c2 ON c2.id = p.category_id";
    ...
    {
        return $this->assertEquals($this->strtrim($expected), $this->strtrim($actual));
    }
